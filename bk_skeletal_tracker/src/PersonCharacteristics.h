...
class PersonCharacteristics
{
	public:
		...
		PersonCharacteristics(const PersonCharacteristics& other); // copy constructor
		PersonCharacteristics( cv::Mat rgb, cv::Mat mask );// Constructor takes an RGB image and a mask
