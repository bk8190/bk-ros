...
(cl:defmethod cl:initialize-instance :after ((m <OrientedBoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OrientedBoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mapping_msgs-msg:<OrientedBoundingBox> is deprecated: use mapping_msgs-msg:OrientedBoundingBox instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <OrientedBoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping_msgs-msg:center-val is deprecated.  Use mapping_msgs-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'extents-val :lambda-list '(m))
(cl:defmethod extents-val ((m <OrientedBoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping_msgs-msg:extents-val is deprecated.  Use mapping_msgs-msg:extents instead.")
  (extents m))

(cl:ensure-generic-function 'axis-val :lambda-list '(m))
(cl:defmethod axis-val ((m <OrientedBoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping_msgs-msg:axis-val is deprecated.  Use mapping_msgs-msg:axis instead.")
  (axis m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <OrientedBoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping_msgs-msg:angle-val is deprecated.  Use mapping_msgs-msg:angle instead.")
  (angle m))
