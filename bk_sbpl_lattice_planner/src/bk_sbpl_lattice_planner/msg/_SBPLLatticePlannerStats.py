"""autogenerated by genmsg_py from SBPLLatticePlannerStats.msg. Do not edit."""
...
class SBPLLatticePlannerStats(roslib.message.Message):
  _md5sum = "b1c85b1cec5e7b196cc477ac1440bbf0"
  _type = "bk_sbpl_lattice_planner/SBPLLatticePlannerStats"
